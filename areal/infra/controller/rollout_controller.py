    ...
    async def _async_initialize(
        ...
        **kwargs,
        ...
        if server_infos is not None:
            ...
            await asyncio.gather(*tasks)
            # The owning rollout controller loads and unloads LoRAs on these shared
            # servers. A second local registry here would become stale after v0 and
            # incorrectly reject later evaluation versions before they reach the
            # server.
        else:

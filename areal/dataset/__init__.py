...
VALID_DATASETS = ["gsm8k", "clevr_count_70k", "geometry3k", "hh-rlhf", "torl_data", "Werewolf", "Hanabi"]
...
def _get_custom_dataset(
    ...
    **kwargs,
    ...
    elif ("hanabi" in path or "Hanabi" in path) and type == "sft":
    ...
    elif ("werewolf" in path or "Werewolf" in path) and type == "rl":
